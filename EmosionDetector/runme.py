...
model = model_from_json(open('EmosionDetector/facial_expression_model_structure.json').read())
model.load_weights('EmosionDetector/facial_expression_model_weights.h5') 
#load weights
#-----------------------------
